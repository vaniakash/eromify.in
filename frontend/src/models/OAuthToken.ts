 ...
 * Expires after 1 year (TTL index).
 *
 * Each token document also carries an optional refreshTokenHash so Claude can
 * request a new access token via grant_type=refresh_token without forcing the
